...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.0/24 -sn -oA tnet | grep for | cut -d" " -f5
...
```shell-session
TomasFerreira@htb[/htb]$ cat hosts.lst
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap -sn -oA tnet -iL hosts.lst | grep for | cut -d" " -f5
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap -sn -oA tnet 10.129.2.18 10.129.2.19 10.129.2.20| grep for | cut -d" " -f5
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap -sn -oA tnet 10.129.2.18-20| grep for | cut -d" " -f5
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --packet-trace 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --reason 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.18 -sn -oA host -PE --packet-trace --disable-arp-ping 
