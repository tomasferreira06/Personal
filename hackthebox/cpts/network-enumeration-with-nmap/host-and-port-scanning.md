...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 --top-ports=10 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -p 21 --packet-trace -Pn -n --disable-arp-ping
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -p 443 --packet-trace --disable-arp-ping -Pn -n --reason -sT 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -p 139 --packet-trace -n --disable-arp-ping -Pn
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -p 445 --packet-trace -n --disable-arp-ping -Pn
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -F -sU
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -sU -Pn -n --disable-arp-ping --packet-trace -p 137 --reason 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -sU -Pn -n --disable-arp-ping --packet-trace -p 100 --reason 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -sU -Pn -n --disable-arp-ping --packet-trace -p 138 --reason 
...
```shell-session
TomasFerreira@htb[/htb]$ sudo nmap 10.129.2.28 -Pn -n --disable-arp-ping --packet-trace -p 445 --reason  -sV
